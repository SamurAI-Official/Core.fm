...
export const translations = {
  en: {
    ...
    // Username Modal
    welcomeTitle: 'Welcome to Core.fm',
    ...
    verdictRateLimited: 'That is a lot of verdicts for one day - this one was saved, but not learned from yet',
    tryAgain: 'Try another take',
    retrying: 'Queuing...',
    retryTake: 'Take',
    retryStarted: 'Another take is rendering -',
    retryTempo: 'tempo',
    retryKey: 'key',
    retryStyleTags: 'different production tags',
    retryWritingStyle: 'a different writing style',
    retryNewSeed: 'a new seed',
    retryNotChanged: 'Left as is:',
    retryFailed: 'Could not queue another take',
    tasteTitle: 'Your taste',
    tasteApply: 'Use',
    tasteMore: 'More of:',
    tasteLess: 'Less of:',
    tasteHint: 'From your own verdicts',
    ...
    emailBody: 'Hey!\n\nI created this AI-generated song and thought you\'d love it:\n\n"{title}" by {creator}\n{style}\n\nListen here: {url}\n\nMade with Core.fm - free and open source local AI music generation!',
  ...
  zh: {
    ...
    verdictRateLimited: '今天的评价次数有点多 – 这条已保存，但暂时不会用于学习',
    tryAgain: '换一个版本',
    retrying: '正在排队...',
    retryTake: '第',
    retryStarted: '正在生成新版本 -',
    retryTempo: '速度',
    retryKey: '调性',
    retryStyleTags: '更换制作标签',
    retryWritingStyle: '换一种写法',
    retryNewSeed: '新的随机种子',
    retryNotChanged: '保持不变：',
    retryFailed: '无法生成新版本',
    tasteTitle: '你的偏好',
    tasteApply: '应用',
    tasteMore: '多一点：',
  ...
  ja: {
    ...
    verdictRateLimited: '一日の評価としては多めです – この評価は保存されましたが、まだ学習には使われません',
    tryAgain: '別テイクを作る',
    retrying: '受け付けています...',
    retryTake: 'テイク',
    retryStarted: '別テイクを生成しています -',
    retryTempo: 'テンポ',
    retryKey: 'キー',
    retryStyleTags: '別の制作タグ',
    retryWritingStyle: '別の作詞スタイル',
    retryNewSeed: '新しいシード',
    retryNotChanged: '変更なし：',
    retryFailed: '別テイクを依頼できませんでした',
    tasteTitle: 'あなたの好み',
    tasteApply: '反映',
    tasteMore: 'もっと：',
    tasteLess: '控えめ：',
    tasteHint: 'あなた自身の評価から',
    ...
    emailBody: 'こんにちは！\n\n私がこのAI生成の曲を作りました。気に入ってもらえると思います：\n\n「{title}」by {creator}\n{style}\n\nここで聴いてください：{url}\n\nCore.fmで作成 - 無料でオープンソースのローカルAI音楽生成！',
  ...
  ko: {
    ...
    // Username Modal
    welcomeTitle: 'Core.fm에 오신 것을 환영합니다',
    ...
    verdictRateLimited: '하루치 평가로는 많은 편입니다 – 이 평가는 저장됐지만 아직 학습에는 쓰이지 않습니다',
    tryAgain: '다른 버전 만들기',
    retrying: '대기 중...',
    retryTake: '버전',
    retryStarted: '다른 버전을 만들고 있습니다 -',
    retryTempo: '템포',
    retryKey: '키',
    retryStyleTags: '다른 프로덕션 태그',
    retryWritingStyle: '다른 작사 스타일',
    retryNewSeed: '새 시드',
    retryNotChanged: '그대로 유지:',
    retryFailed: '다른 버전을 요청하지 못했습니다',
    tasteTitle: '내 취향',
    tasteApply: '적용',
    tasteMore: '더 많이:',
    tasteLess: '덜:',
