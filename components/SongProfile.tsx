...
const updateMetaTags = (song: Song) => {
    ...
    const title = `${song.title} by ${song.creator || 'Unknown Artist'} | Core.fm`;
    const description = `Listen to "${song.title}" - ${song.style}. ${song.viewCount || 0} plays, ${song.likeCount || 0} likes. Create your own AI music with Core.fm.`;
...
const resetMetaTags = () => {
    document.title = 'Core.fm - Local AI Music Generator';
    ...
    updateMeta('meta[property="og:title"]', 'Core.fm - Local AI Music Generator');
    ...
    updateMeta('meta[name="twitter:title"]', 'Core.fm - Local AI Music Generator');
